...
parser.add_argument('--dataset', default='pain_study', type=str)
parser.add_argument('--text_file', default='pain_preprocessed_data.csv', type=str)
...
kv.save(f'Data/{args.dataset}/embeddings/embedding_{args.model}_iv')